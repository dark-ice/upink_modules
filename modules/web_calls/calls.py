...
REGIONS = {
    ...
    'kiev': {'yandexmarket_KIEV', 'SEO_KIEV', 'kont_google_Kiev', 'kont_yandex_KIEV', 'smm_KIEV', 'catalog_KIEV',
             'seo_KIEV', 'Kiev', 'Kiev_region', 'Kiev-service', 'SEO_KIEV', 'LuckyPrint', r"(LuckyPrint)", 'HotUkraine', 'HotLucky'},
    ...
    'irkutsk': {'Irkutsk', 'Irkutsk1'},
    'alm': {'Alm_region', 'Kazahstan'},
    'krasnodar': {'Krasnodar', 'Krasnodar1'},
    'volgograd': {'Volgograd', 'Volgograd-region'},
    'ufa': {'Ufa'},
    'krasnoyarsk': {'Krasnoyarsk'},
    'perm': {'Perm', 'Perm-region'},
    'omsk': {'Omsk'},
    'odessa': {'Odessa'},
    'dnepr': {'Dnepr'},
    'donetsk': {'Donetck'},
    'voronezh': {'Voronej', 'Voronej-region'},
    'saratov': {'Saratov', 'Saratov1', 'Saratov-site'},
    'kharkov': {'Kharkov', 'KharkovCall is forwarded'},
