...
class document_file(osv.osv):
    ...
    def default_get(self, cr, user, fields_list=[], context=None):
        data = super(document_file, self).default_get(cr, user, fields_list, context)
        data['res_model'] = context.get('res_model', False)
        data['tmp_res_model'] = context.get('tmp_res_model', False)
        return data
