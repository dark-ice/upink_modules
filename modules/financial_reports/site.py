...
class SiteReport(Model):
    _name = 'financial.reports.site'
    _description = u'Финансовые отчеты - Site'
    ...
    _columns = {
        ...
        'line_ids': fields.function(
            _line_ids,
            relation='financial.reports.site.line',
            type="one2many",
            string='Линии отчета',
            method=True,
            store=False,
    ...
    _defaults = {
        'state': 'draft',
        'check_h': lambda s, c, u, cnt: u == 567 or u == 1,
    }
SiteReport()


class SiteReportLine(Model):
    _name = 'financial.reports.site.line'
    _description = u'Финансовые отчеты - SITE - Линия отчета'
